...
export const get_all_scripts = (data) => {
    ...
    let SCRIPTS = []
    const frame_details_info = [data.grammar, data.fontInfo.fontSize, data.frameWidth, 
        data.frameHeight, data.ySing, data.yWait, data.fontInfo.fontName, data.fontInfo.fontWordSpacing]
